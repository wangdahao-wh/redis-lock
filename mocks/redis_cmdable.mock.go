...
func (m *MockCmdable) VLinks(ctx context.Context, key, element string) *v9.StringSliceCmd {
	m.ctrl.T.Helper()
...
func (m *MockCmdable) VLinksWithScores(ctx context.Context, key, element string) *v9.VectorScoreSliceCmd {
	m.ctrl.T.Helper()
